...
while 1:
	...
	x13 = random.choice(lines)
	x14 = random.choice(lines)
	x15 = random.choice(lines)
	x16 = random.choice(lines)
	x17 = random.choice(lines)
	x18 = random.choice(lines)
	x19 = random.choice(lines)
	x20 = random.choice(lines)
	x21 = random.choice(lines)
	x22 = random.choice(lines)
	x23 = random.choice(lines)
	x24 = random.choice(lines)
	words = x1+ " "+ x2+" "+x3+" "+x4+" "+x5+" "+x6+" "+x7+" "+x8+" "+x9+" "+x10+" "+x11+" "+x12+" "+x13+ " "+ x14+" "+x15+" "+x16+" "+x17+" "+x18+" "+x19+" "+x20+" "+x21+" "+x22+" "+x23+" "+x24
	print(words)
	...
	try:
		...
		wx= wallet.keystore.root_derivation = "m/49'/0'/0'"
		print(wx)
